<template>
    <b-container fluid>
            <mq-layout mq="sm">
                <b-row class="fixed-navbar">
                    <b-col cols="12" md="6" class="pt-3 border-bottom">
                        <div class="pb-5 pt-1">
                            <router-link to="/home">
                                <img class="logo pb-3" src="~/assets/medeea-logo.png">
                            </router-link>   
                        </div>
                    </b-col>
                </b-row>
            ...
            <mq-layout mq="lg">
                <b-row class="fixed-navbar">
                    <b-col cols="12" md="6" class="border-right pt-3">
                    ...
                    <b-col cols="12" md="3" class="border-right header-padding-bottom pt-3">
...
<script>
     export default {
        data: function(){
            return {
                link: 'https://www.instagram.com/medeeae/'
            }
        }
    }
</script>
